...
As inspected on 2026-07-22, this working tree declares package version 0.11.0b2 but has no
`v0.11.0b2` Git tag and keeps the 0.11.0 security work in the Unreleased
changelog section. It is candidate `warrantos-0.11.0b2-local-rc.1` and must be
