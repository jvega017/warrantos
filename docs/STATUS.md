...
**Canonical release state:** 0.11.0 local release candidate rc.1 (`git_tag: null`; latest
...
repository contains the declared code, tests and an observed runtime control.
It does not mean independently evaluated, certified or production qualified.
The four maturity dimensions for this checkout are:

| Implemented | Enforced | Evaluated | Production qualified |
|---|---|---|---|
| Yes | Yes | Yes, on declared internal corpora | **No** |
...
- **Legacy BUILT rows**: 20
- **Production-qualified rows**: 0 (no independent qualification claim is made)
