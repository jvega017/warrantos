...
|---|---|---|
| `0.11.0b2` local release candidate rc.1 | Candidate only | v2 bundle binding, evidence-only claim semantics and pinned-trust verification are implemented and tested; no `v0.11.0b2` tag or production qualification |
...
**Mitigation:**
1. Use a reviewed local release candidate that declares `0.11.0b2`, or wait for a tagged release containing the v2 binding. Confirm the emitted checkpoint is `warrantos-checkpoint-v2`.
