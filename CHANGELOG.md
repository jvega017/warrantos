...
- **Hardened scaffold-bleed detection.** The canonical residue list gains four families: delivery meta-commentary ("Below is a", "Here's a breakdown"), sycophantic agreement ("You're absolutely right"), offers to continue ("Don't hesitate to ask", "If you'd like, I can"), and edit narration ("I've updated", "I have revised the"). Both the G1 boundary gate and `slop` consume the same list, so both surfaces gain the coverage at once.
