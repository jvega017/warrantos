...
- **F-integrity confirmed BUILT** and surfaced in the rollup. Build state moves from **13 BUILT / 3 PARTIAL / 2 STARTER / 2 NOT_BUILT** at v0.9.1 to **17 BUILT / 3 PARTIAL** at v0.9.2. The three remaining PARTIAL rows are F-policy, F-compliance, and F-metrics.
